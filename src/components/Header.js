                                    ...
                                    <ul className="nav-top-left">
                                        <li>
                                            <div onClick={this.toggleCurrency}
                                                 className={`${this.state.openCurrency ? "currency-selector dropdown" : "currency-selector dropdown open"}`}>
                                        ...
                                        <li>
                                            <div onClick={this.toggleLeng}
                                                 className={`${this.state.openLeng ? "site-lng dropdown" : "site-lng dropdown open"}`}>
                                                <div className="button-lng-box dropdown-button-tl"
                                                     data-toggle="dropdown" role="button"
                                                     aria-expanded={`${this.state.openLeng ? "false" : "true"}`}>Русский
                                                </div>
                                    ...
                                    <div className="nav-site-wrapp">
                                        <nav className="nav-site">
                                            <ul className="nav-site-mnu clearfix">
                                                <li><Link to="/product">{t('Popular')}</Link></li>
                                                <li><Link to="/shares">{t('Stocks')}</Link></li>
                                                <li><Link to="/latest">{t('New items')}</Link></li>
